# flake8: noqa
"""
Django settings for blackinbioanth project.
...
DJANGO_ROOT = root.path('blackinbioanth')
...
ROOT_URLCONF = 'blackinbioanth.urls'
...
WSGI_APPLICATION = 'blackinbioanth.wsgi.application'
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///blackinbioanth'),
}
...
WAGTAIL_SITE_NAME = "Black in Biological Anthropology"
